"""Sunny - Security Module.

Component: SCRT001A
Domain: SC (Security) | Category: RT (Runtime)
...
#: API key length (bytes, hex-encoded = 2x)
...
class SecurityConfig:
    ...
    Component: SCRT001A.SecurityConfig

    Invariants:
        - If trust_model == NETWORK, api_key must be set
...
class RateLimiter:
    ...
    Component: SCRT001A.RateLimiter
...
class ValidationError(Exception):
    ...
    Component: SCRT001A.ValidationError
    """
